...
async function page({ params, searchParams }: { params: { id: string | number }, searchParams: any }) {
  ...
  if (artist) {
    ...
    const url = (path) => 'https://tvuqvrbxusmicpmjqpus.supabase.co/storage/v1/object/public/artist_images/'+ path
    ...
    return (
      <div className="relative min-h-screen overflow-y-visible overflow-x-hidden">
        <div className="absolute inset-0">
          <Image alt={artist?.artist_name} src={url(artist.image_url)} fill className=" object-cover scale-150 blur" />
        </div>
