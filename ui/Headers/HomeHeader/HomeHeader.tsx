  ...
  return (
    <section className="min-h-[600px] h-full bg-white dark:bg-black flex items center overflow-hidden border-b border-zinc-200 dark:border-zinc-800 relative">
      ...
      <div>
        ...
        <h1 className="relative text-4xl md:text-5xl lg:text-7xl font-medium font-owners text-center tracking-wider ">
          Your
          <span className="text-transparent bg-clip-text bg-gradient-to-r to-red-400 from-red-200">
            {" "}
            Global Music
          </span>{" "}
          Partner.
        </h1>
        <p className=" px-4 max-w-2xl mx-auto text-center justify-center py-8 sm:text-lg font-light text-zinc-500 md:text-xl dark:text-zinc-300">
          {introP}
        </p>
