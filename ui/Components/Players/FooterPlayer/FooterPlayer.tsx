    ...
    return (
       (
            <footer className="cursor-pointer sm:cursor-default" >
                <div className={`fixed bottom-16 sm:bottom-0 left-0 right-0 z-[250] border-zinc-200 dark:border-zinc-800 md:px-6 py-2.5 border-t w-full bg-white dark:bg-black ${audioRef && audioUrl ? 'block' : 'hidden md:block'}`}>
                            ...
                            <div  className="player-drawer flex items-center justify-between max-w-screen-xl mx-auto w-full">
                                ...
                                <div className="mx-auto w-full space-x-4 relative flex items-center ">
                                    ...
                                    <input
                                        ...
                                        className="w-32 md:w-48 bg-zinc-200 accent-blue-600 rounded-md cursor-pointer dark:bg-zinc-700 hidden sm:block  "
                                    />
                                </div>
                            </div>}
                        {/* Step 3: Drawer JSX */}
