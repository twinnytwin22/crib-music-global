...
function MenuItemMenu({ song }) {
  ...
  return (
    ...
    >
      <ul
        className={`w-fit text-sm font-medium text-zinc-900 bg-white border border-zinc-200 rounded-md dark:bg-zinc-900 dark:border-zinc-700 dark:text-white opacity-90 shadow-sm shadow-zinc-500 relative  `}
      >
        ...
        <li className="w-full px-4 py-2 hidden justify-between border-b border-zinc-200 rounded-t-lg dark:border-zinc-600 hover:dark:bg-zinc-700">
          Share on Twitter
          <FaTwitter />
        </li>
        <li
