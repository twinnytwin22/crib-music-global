      ...
      <div>
        <div className=" relative z-10  font-work-sans place-items-center text-sm">
          <ul className="text-black dark:text-white text-center ">
            <li
              onClick={() => setFilterWindowOpen(!filterWindowOpen, "genres")}
              className="aspect-video border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-center hover:bg-white dark:hover:bg-black duration-200 ease-in-out"
            >
              Genres
            </li>
            <li
              onClick={() => setFilterWindowOpen(!filterWindowOpen, "artists")}
              className="aspect-video border-b border-zinc-200 dark:border-zinc-800  flex items-center justify-center hover:bg-white dark:hover:bg-black duration-200 ease-in-out"
            >
              Artists
            </li>
            <li
              onClick={() => setFilterWindowOpen(!filterWindowOpen, "moods")}
              className="aspect-video border-b border-zinc-200 dark:border-zinc-800  flex items-center justify-center hover:bg-white dark:hover:bg-black duration-200 ease-in-out"
            >
              Moods
            </li>
