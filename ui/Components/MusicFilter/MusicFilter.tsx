...
function MusicFilter() {
  ...
  return (
    <section className="py-4 pt-8 w-full max-w-screen-2xl mx-auto rounded-md justify-center select-none">
      <div className="z-20 p-4 overflow-hidden bg-white shadow dark:bg-black sm:rounded-md w-full border border-zinc-200 dark:border-zinc-800">
        <div>
          <div className="flex flex-col justify-between space-y-4">
            <div>
              <button
                className={`bg-red-100 my-3 space-y-2 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-zinc-700 dark:text-red-300 border border-red-400 `}
                onClick={handleClear}
              >
                Reset
              </button>

              <p className="font-owners tracking-wide ">Filter Genres:</p>
            ...
            <div>
              <p className="font-owners tracking-wide ">Filter Artists:</p>
              <ul className="flex flex-wrap space-x-2">
                {artists.length > 0 &&
