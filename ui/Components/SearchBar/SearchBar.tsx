...
function SearchBar() {
    ...
    return (
        ...
        <form className="block lg:pl-2 w-72 md:w-96">
            <div className="relative z-0">
                <input
                    ...
                    type="text"
                    id="default_standard"
                    className="block py-2.5 px-0 w-full text-sm text-zinc-900 bg-transparent border-0 border-b-2 border-zinc-300 appearance-none dark:text-white dark:border-zinc-600 dark:focus:border-red-300 focus:outline-none focus:ring-0 focus:border-red-300 peer"
                    placeholder=" "
                    value={searchTerm}
        ...
        {isOpen && (
        <div className="absolute max-w-md w-full top-10 left-0  mt-6  bg-white max-h-[300px] overflow-y-scroll dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-2xl rounded-md z-[99990] shadow-zinc-300 dark:shadow-black search-results mx-auto">
