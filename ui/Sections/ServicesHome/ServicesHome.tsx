  ...
  return (
    <div>
      <div className="flex items-center -ml-4">
        ...
        <h3 className="mb-2 text-xl font-medium font-owners dark:text-white">
          {title}
        </h3>
      </div>
      <p className="text-zinc-500 dark:text-zinc-300 font-light">
        {shortDescription}
      </p>
    </div>
  );
        ...
        <div className="md:flex justify-between items-start md:space-x-8">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            ...
            <p className="text-zinc-500 sm:text-xl dark:text-zinc-300 font-light">
              We offer music licensing, administration, and supervision
              services, connecting both musicians and content creators to global
              success. .
            </p>
          </div>
